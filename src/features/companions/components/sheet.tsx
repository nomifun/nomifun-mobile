/**
 * Bottom sheet used by the companion feature (create companion, memory detail).
 * RN `Modal` is available on react-native-web too, so one implementation covers
 * iOS / Android / web; the backdrop press and the header close button both exit.
 */
...
export function Sheet({ visible, title, onClose, footer, closeLabel, children }: SheetProps) {
